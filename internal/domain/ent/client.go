...
import (
	...
	"github.com/kvngho/clayful-monitoring/internal/domain/ent/migrate"
	...
	"github.com/kvngho/clayful-monitoring/internal/domain/ent/user"
)
...
type (
	hooks struct {
		Coupon, Product, User []ent.Hook
	}
	inters struct {
		Coupon, Product, User []ent.Interceptor
	}
)
